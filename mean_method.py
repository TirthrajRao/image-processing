...
def calculateMean(topLeft, topMiddle, topRight, middleLeft, middle, middleRight, bottomLeft, bottomMiddle, bottomRight):
	arr = []

	first = (int(topLeft[0]) * 0) + (int(topMiddle[0]) * 1) + (int(topRight[0]) * 2) + (int(middleLeft[0]) * 2) + (int(middle[0]) * 2) + (int(middleRight[0]) * 2) + (int(bottomLeft[0]) * 2) + (int(bottomMiddle[0]) * 2) + (int(bottomRight[0]) * 2)
	first = first / 9
	arr.append(first)
	...
	arr.append(((int(topLeft[1]) * 2) + (int(topMiddle[1]) * 2) + (int(topRight[1]) * 2) + (int(middleLeft[1]) * 2) + (int(middle[1]) * 2) + (int(middleRight[1]) * 2) + (int(bottomLeft[1]) * 2) + (int(bottomMiddle[1]) * 2) + (int(bottomRight[1]) * 2))/ 9)
	arr.append(((int(topLeft[2]) * 2) + (int(topMiddle[2]) * 2) + (int(topRight[2]) * 2) + (int(middleLeft[2]) * 2) + (int(middle[2]) * 2) + (int(middleRight[2]) * 2) + (int(bottomLeft[2]) * 2) + (int(bottomMiddle[2]) * 2) + (int(bottomRight[2]) * 2))/ 9)
	return arr
...
# 			# image1[i][j] = calculateMean(image1[i-1][j-1], image1[i-1][j], image1[i-1][j+1], 
# 			# 	image1[i][j-1], image1[i][j], image1[i][j+1],
# 			# 	image1[i+1][j-1], image1[i+1][j], image1[i+1][j+1]
# 			# 	)
# 		j = j + 1
